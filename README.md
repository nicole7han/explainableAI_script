...
4. You can put in your name initials (make sure to keep it the same between blocks. e.g., for example, my name is Nicole Han so I put "NH" as my subject name), age, and gender to start! Repeat this process to complete 6 blocks.
